    ...
    return Scaffold(
      ...
      body: FutureBuilder(
          future: AppFunctions.loadStoreReference(
              widget.order.storeRef as DocumentReference),
              ...
              return Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: AppText(
                        text:
                            'Opens at ${AppFunctions.formatDate(store.openingTime.toString(), format: 'h:i A')}'),
                  ),
                  const Gap(10),
                  Padding(
                    padding: const EdgeInsets.symmetric(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            AppText(
                              text:
                                  'Order ${widget.order.status.toLowerCase()}',
                    ...
                    Column(
                      children: [
                        ListTile(
                          ...
                          title: AppText(
                              text:
                                  'Tip: ${widget.order.tip!.toStringAsFixed(2)}'),
                        ),
                        const Divider(
                          indent: 40,
                        )
                  ...
                  ListTile(
                    ...
                    title: AppText(
                        text:
                            'Total: ${widget.order.totalFee.toStringAsFixed(2)}'),
                  ),
                  const Divider(
                    indent: 40,
                  ),
                  ListTile(
                    ...
                    title: AppText(
                        text: 'Your delivery by ${widget.order.courier}'),
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      navigatorKey.currentState!.push(MaterialPageRoute(
                        builder: (context) =>
                            const WhatDeliveryPeopleSeeScreen(),
                      ));
                    },
                  ),
                  const Gap(40),
