                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const Gap(40),
                          AppText(
                            text: _selectedReceipt == 'Receipt including tip'
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: AppText(
                                      size: AppSizes.bodySmall,
                                      text:
                                          ' You saved US\$${(widget.order.promo!.discount / 100) * widget.order.totalFee} on this order with Uber One and promos'),
                                )
                              ],
                            )
                        ],
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          AppText(
                            size: AppSizes.bodySmall,
                            text: 'US\$${(widget.order.tax / 100) * subtotal}',
                          )
                        ],
                      ),
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            leading: Image.asset(
                              payment.paymentMethod.assetImage,
                              width: 20,
                              fit: BoxFit.cover,
                            ),
                            subtitle: AppText(
                            ...
                            title: AppText(
                                weight: FontWeight.w600,
                                text:
                                    '${payment.paymentMethod.name} ••••${payment.cardNumber.substring(4)}'),
                          );
                        },
                      ),
                      const Divider(),
