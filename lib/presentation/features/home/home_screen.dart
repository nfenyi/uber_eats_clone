...
//     closingTime: DateTime(2000, 1, 1, 9, 30),
//     name: "McDonald's",
//     isUberOneShop: true,
//     doesPickup: false,
...
final List<FavouriteStore> favoriteStores = [];
                        ...
                        ChipsChoice<String>.multiple(
                          ...
                          onChanged: (value) {
                            ...
                            if (value.any(
                              ...
                              if (OtherConstants.filters.indexOf(newFilter) ==
                                  3) {
...
class SearchResultDisplay extends StatelessWidget {
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return SizedBox(
                            ...
                            child: FutureBuilder<Product>(
                                future:
                                    _loadDocumentReference(productReference),
                                builder: (context, snapshot) {
  ...
  Future<Product> _loadDocumentReference(
