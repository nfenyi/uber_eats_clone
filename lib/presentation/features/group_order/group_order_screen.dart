              ...
              children: [
                ...
                GestureDetector(
                    onTap: () =>
                        navigatorKey.currentState!.push(MaterialPageRoute(
                          builder: (context) =>
                              GroupOrderSettingsScreen(store: _store),
                        )),
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      AppText(
                                                          text:
                                                              'Deliver by ${AppFunctions.formatDate(orderSchedule.deliveryDate.toString(), format: r'D, M j')} at ${AppFunctions.formatDate(orderSchedule.deliveryDate.toString(), format: 'g:i A')} to ${_groupOrder.placeDescription}'),
                                                      const Gap(10),
                                                      Container(
                                                        padding:
                                                            const EdgeInsets
