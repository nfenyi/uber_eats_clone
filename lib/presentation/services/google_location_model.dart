...
//
//     final googleLocationResponse = googleLocationResponseFromJson(jsonString);

import 'dart:convert';

PredictionsResponse googleLocationResponseFromJson(String str) =>
    PredictionsResponse.fromJson(json.decode(str));

String googleLocationResponseToJson(PredictionsResponse data) =>
